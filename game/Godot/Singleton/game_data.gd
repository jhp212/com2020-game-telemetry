...
func update_data() -> void:
	...
	enemy_data = {
		...
		"small_circle": {
			"health": 40,
			"speed": 120 * enemy_speed_multiplier,
		...
		"mini_boss_circle": {
			...
			"cash": 400 * money_earned_multiplier,
			"damage": 70 * enemy_damage_multiplier
		},
		"big_boss_circle": {
			"health": 10000,
			"speed": 40 * enemy_speed_multiplier,
			"cash": 750 * money_earned_multiplier,
...
var level_data = {
	"Level1": {
		"number_of_waves": 5,
		"wave_1": [[mc, 1], [mc, 1], [mc, 1], [mc, 1], [mc, 5]],
		"wave_2": [[sc, 1], [sc, 1], [sc, 1], [sc, 1], [sc, 5]],
		"wave_3": [[lc, 2], [lc, 2], [lc, 5]],
		"wave_4": [[sc, 1], [sc, 1], [sc, 1], [mc, 2], [mc, 2], [mc, 2], [lc, 3], [lc, 3], [lc, 5]],  
		"wave_5": [[mbc, 20]],
	},
	"Level2": {
		"number_of_waves": 10,
		...
		"wave_4": [[sc, 1], [sc, 1], [sc, 1], [mc, 2], [mc, 2], [mc, 2], [lc, 3], [lc, 3], [lc, 5]],  
		"wave_5": [[mbc, 20]],
		"wave_6": [[lc, 1], [lc, 1], [lc, 3], [mc, 1], [mc, 1], [mc, 3], [sc, 0.5], [sc, 0.5], [sc, 5]],
		"wave_7": [[lc, 2], [mc, 3], [lc, 2], [mc, 3], [lc, 2], [mc, 3], [lc, 2], [mc, 3], [lc, 2], [mc, 3], [lc, 2], [mc, 5]],
		"wave_8": [[sc, 0.5], [sc, 0.5], [sc, 0.5], [sc, 0.5], [sc, 0.5], [sc, 2], [lc, 1], [lc,2], [mc, 2], [lc, 1], [lc, 2], [sc, 0.5], [sc, 0.5], [sc, 0.5], [sc, 0.5], [sc, 0.5], [sc, 5]],
		"wave_9": [[lc, 0.5], [lc, 0.5], [lc, 0.5], [sc, 0.5], [lc, 0.5], [lc, 0.5], [lc, 0.5], [sc, 0.5], [lc, 0.5], [lc, 0.5], [lc, 5]],
		"wave_10": [[bbc, 20]],
	},
	"Level3": {
		"number_of_waves": 15,
	...
	"Level4": {
		...
		"wave_20": [[bbc, 5], [sc, 1], [sc, 1], [sc, 1], [sc, 1], [sc, 5], [mbc, 15]],
	},
	"Level5": {
		"number_of_waves": 25,
		"wave_1": [[mc, 1], [mc, 1], [mc, 1], [mc, 1], [mc, 5]],
