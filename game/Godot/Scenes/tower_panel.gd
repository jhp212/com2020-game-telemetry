...
func set_tower(tower):
	if tower == sold:
		...
		if stage == 3:
			...
			$VBoxContainer/HBoxContainer/Panel/MarginContainer/VBoxContainer/HBoxContainer/Cost.text = ""
		else:
			...
			$VBoxContainer/HBoxContainer/Panel/MarginContainer/VBoxContainer/HBoxContainer/Cost.text = str("$ " + str(GameData.tower_upgrades[ttype]["1cost"]))
